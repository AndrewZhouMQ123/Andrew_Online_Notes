...
const cssDiv = document.querySelector('#cssCheatSheet');
const selectorstable = cssDiv.querySelector('#selectors');
const selectcap = document.createElement('caption');
selectcap.innerHTML = "CSS Selectors";
selectorstable.appendChild(selectcap);
const selecthead = selectorstable.querySelector('thead');
const selectrow = document.createElement('tr');
selecthead.appendChild(selectrow);
const selectkeys = ["Selector", "Description"];
for (let str of selectkeys) {
    const head = document.createElement('th');
    head.innerHTML = str;
    selectrow.appendChild(head);
}
;
const selectorstbody = selectorstable.querySelector('tbody');
...
const propstable = cssDiv.querySelector('#properties');
const propscap = document.createElement('caption');
propscap.innerHTML = "CSS properties";
propstable.appendChild(propscap);
const propsthead = propstable.querySelector('thead');
const propsrow = document.createElement('tr');
propsthead.appendChild(propsrow);
const propskey = ["Property", "Description", "Values"];
for (let str of propskey) {
    const head = document.createElement('th');
    head.innerHTML = str;
    propsrow.appendChild(head);
}
;
const propstbody = propstable.querySelector('tbody');
...
const pseudoDiv = document.querySelector('#pseudo');
const pseudotable = pseudoDiv.querySelector('#pseudo-classes');
const pseudocap = document.createElement('caption');
pseudocap.innerHTML = "CSS Pseudo Classes";
pseudotable.appendChild(pseudocap);
const pseudothead = pseudotable.querySelector('thead');
const pseudorow = document.createElement('tr');
...
for (let str of pseudokeys) {
    const head = document.createElement('th');
    head.innerHTML = str;
    pseudorow.appendChild(head);
}
;
const pseudotbody = pseudotable.querySelector('tbody');
...
const petable = pseudoDiv.querySelector('#pseudo-elements');
const petcap = document.createElement('caption');
petcap.innerHTML = "CSS Pseudo Elements";
petable.appendChild(petcap);
const petthead = petable.querySelector('thead');
...
for (let str of petkeys) {
    const head = document.createElement('th');
    head.innerHTML = str;
    petrow.appendChild(head);
}
;
const petbody = petable.querySelector('tbody');
...
const logicdiv = document.querySelector("#cssLogic");
const datatable = logicdiv.querySelector("#datatypes");
const datacap = document.createElement('caption');
...
const functable = logicdiv.querySelector("#functions");
const funcap = document.createElement('caption');
funcap.innerHTML = "CSS Functions";
functable.appendChild(funcap);
const functhead = functable.querySelector('thead');
const funcrow = document.createElement('tr');
functhead.appendChild(funcrow);
const funckeys = ["Function", "Description", "Parameter"];
for (let str of funckeys) {
    const head = document.createElement('th');
    head.innerHTML = str;
    funcrow.appendChild(head);
}
;
const functbody = functable.querySelector('tbody');
...
const ATtable = logicdiv.querySelector("#atRuleDesc");
const ATcap = document.createElement('caption');
...
;
const ATtbody = ATtable.querySelector('tbody');
...
const globalsdiv = document.querySelector("#globals");
const keytable = globalsdiv.querySelector('table');
const globalscap = document.createElement('caption');
globalscap.innerHTML = "CSS Global Values and Key Concepts";
keytable.appendChild(globalscap);
const keythead = keytable.querySelector('thead');
...
;
const keytbody = keytable.querySelector('tbody');
...
export {};
//# sourceMappingURL=cssblog.js.map