const pageWrapDiv = document.querySelector('#html-elements');
const metadata = [
    {
        element: "&lt;html&gt;",
...
const metatable = pageWrapDiv.querySelector('#metadata');
const metatbody = metatable.querySelector('tbody');
...
const headingtable = pageWrapDiv.querySelector('#headings');
const headingtbody = headingtable.querySelector('tbody');
...
const inlinetable = pageWrapDiv.querySelector('#inline');
const inlinetbody = inlinetable.querySelector('tbody');
...
const formtable = pageWrapDiv.querySelector('#forms');
const formtbody = formtable.querySelector('tbody');
...
const mediatable = pageWrapDiv.querySelector('#media');
const mediatbody = mediatable.querySelector('tbody');
...
const tablestable = pageWrapDiv.querySelector('#tables');
const tablestbody = tablestable.querySelector('tbody');
...
const globaltable = extraDiv.querySelector('#globals');
const globaltbody = globaltable.querySelector('tbody');
...
const entitiesDiv = document.querySelector('#HTML-entities');
const entitiestable = entitiesDiv.querySelector('#entities');
...
export {};
//# sourceMappingURL=htmlblog.js.map