...
const pageWrapDiv = document.querySelector('#linux-MacOS') as HTMLDivElement;
const table = pageWrapDiv.querySelector('#commands') as HTMLTableElement;
...
const shorttable = pageWrapDiv.querySelector('#shortcuts') as HTMLTableElement;
const shorttbody = shorttable.querySelector('tbody') as HTMLTableSectionElement;
...
const HTTPSdiv = document.querySelector('#HTTPS') as HTMLDivElement;
const rqtable = HTTPSdiv.querySelector('#rqmethods') as HTMLTableElement;
const rqtbody = rqtable.querySelector('tbody') as HTMLTableSectionElement;
...
const sctable = HTTPSdiv.querySelector('#statuscodes') as HTMLTableElement;
const sctbody = sctable.querySelector('tbody') as HTMLTableSectionElement;
...
const termtable = HTTPSdiv.querySelector('#terms') as HTMLTableElement;
const termtbody = termtable.querySelector('tbody') as HTMLTableSectionElement;
...
const headerstable = HTTPSdiv.querySelector('#headers') as HTMLTableElement;
const headertbody = headerstable.querySelector('tbody') as HTMLTableSectionElement;
