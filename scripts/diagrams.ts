...
function drawCSSsyntax() {
  ...
  if (canvas.getContext) {
    ...
    const a1 = drawArrow(ctx, 30, 60, 30, 18, 3, 'black');
    arrows.push(a1);

    const a2 = drawArrow(ctx, 90, 58, 170, 15, 3, 'black');
    arrows.push(a2);

    const a3 = drawArrow(ctx, 165, 100, 80, 140, 3, 'black');
    arrows.push(a3);

    const a4 = drawArrow(ctx, 272, 88, 300, 75, 3, 'black');
    arrows.push(a4);

    const a5 = drawArrow(ctx, 350, 100, 420, 110, 3, 'black');
    arrows.push(a5);
